...
import { SearchResultItem, UiLanguage } from '../types';
...
const SearchResults: React.FC<SearchResultsProps> = ({ results, lang }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      <div className="flex items-center gap-3 mb-6 border-t border-slate-200 dark:border-white/10 pt-8 transition-colors">
        ...
        <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em]">{t.results.title}</h3>
      </div>
